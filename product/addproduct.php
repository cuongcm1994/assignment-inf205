          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                      <form action="readdproduct.php" method="post">
                        ...
                        <div class="form-group col-md-12" style="margin-bottom: 20px;">
                          ...
                          <div class="col-md-10 col-sm-10 col-xs-10">
                              <div class="input text">
                                <input name="txtcontent" class="form-control col-md-7 col-xs-12" type="text" id="">
                              </div>                                    
                          </div>
                        </div>
                        <div class="form-group col-md-12" style="margin-bottom: 20px;">
                          ...
                          <div class="col-md-10 col-sm-10 col-xs-10">
                              <div class="input text">
                                <input name="txtprice" class="form-control col-md-7 col-xs-12" type="number" id="">
                              </div>                                    
                          </div>
                        </div>
                        <?php
