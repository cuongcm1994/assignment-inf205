          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li class="active"><a href="../catproduct/catproduct.php"><i class="fa fa-user"></i> Danh mục sản phẩm </a></li>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title col-md-12 col-xs-12 col-md-12">
                        ...
                        <div class="col-md-2">
                            <div class="col-md-6">
                                <a href="catproduct.php"><i class="glyphicon glyphicon-triangle-left"></i> Huỷ</a>
                            </div>
                        </div>
                    </div>
                    <div class="x_content">
                    ...
                    if (isset($_GET['id'])){
                    $ma=$_GET['id'];
                    $sql="select * from catproducts where id='$ma'";
                    $result=$db->query($sql);
                    ...
                    ?>
                      <form action="reeditcatproduct.php" method="post">

                        <div class="form-group col-md-12" style="margin-bottom: 20px;">
                          <label for="idtitle" class="control-label col-md-2 col-sm-2 col-xs-12" style="padding-top: 8px;">Tên danh mục sản phẩm</label>
